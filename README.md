...
### Computer Science Engineering Student • Cybersecurity • AI • Full-Stack Development
...
<img src="https://komarev.com/ghpvc/?username=yashasyadavr&label=Profile%20Views&color=0e75b6&style=flat-square" alt="Profile views" />
...
<p>
  <img src="https://skillicons.dev/icons?i=c,python,java,js,ts" alt="C, Python, Java, JavaScript, and TypeScript" />
</p>

### Frontend

<p>
  <img src="https://skillicons.dev/icons?i=html,css,js,react,angular,ts" alt="HTML, CSS, JavaScript, React, Angular, and TypeScript" />
</p>

### Backend & Databases

<p>
  <img src="https://skillicons.dev/icons?i=spring,fastapi,mysql,postgres" alt="Spring Boot, FastAPI, MySQL, and PostgreSQL" />
</p>
...
I'm a Computer Science Engineering student at K.S. Rangasamy College of Technology, graduating in 2028.

I enjoy understanding how systems work, solving real-world problems, and turning ideas into practical software.
...
- 🛡️ Secure Data Systems

---

# 🚀 What I Build

- **Cybersecurity** → Fake Profile Detection • Data Sanitization • Secure Systems
- **AI** → Computer Vision • NLP • Risk Analysis
- **Full-Stack** → React • Angular • Spring Boot • FastAPI
- **Backend** → REST APIs • JWT • MySQL • PostgreSQL
...
- Automated Instagram profile data collection
- Candidate discovery using Instagram search
- Multimodal profile analysis
- Username similarity and behavioural features
- XGBoost-based classification
- Risk assessment and reporting
- JWT authentication

**Tech Stack:** React.js, Spring Boot, FastAPI, Python, Java, MySQL, Apify, XGBoost, ArcFace, SentenceTransformer, OpenCLIP, JWT
...
- Secure file and data wiping
- Multi-standard deletion
- AI-assisted sensitive-data detection
- Tamper-proof audit certificates
- Android reset through ADB
- OCR-based sensitive-data detection
- QR-based certificate verification

**Supported Standards:** Gutmann, DoD, NIST

**Tech Stack:** Python, CustomTkinter, Cryptography, ReportLab, Segno, ADB, JSON, spaCy, Microsoft Presidio, YOLOv8, Tesseract OCR
...
**Tech Stack:** Spring Boot, Angular, PostgreSQL, JWT

---

# 🏆 Achievements

- 🏅 State-Level Finalist — Nimirundhu Nil Hackathon, Tamil Nadu 2026
- 🥇 5th Place — E-Box Codathon
- 💻 100+ LeetCode Problems Solved
- 🚀 Selected in Internal SIH Hackathon for CipherForge
